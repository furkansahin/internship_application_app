...
<html lang="en">
  ...
  <?php
...

    {
        ...
        $sql = "SELECT * FROM company WHERE cid NOT IN (SELECT cid FROM company NATURAL JOIN apply WHERE sid=".$user_id.");";
        ...
        echo "<form action=\""if ($i >= 3) echo "fail.php\""; else echo "addInternship.php\""; echo " method=\"post\">
              <tr align=\"center\">
